      ...
      <div class="dropdown">
        <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
          <div class="avatar avatar-md2">
            <img src="/template/assets/compiled/jpg/1.jpg" alt="Avatar">
          </div>
          <div class="text">
            <h6 class="user-dropdown-name">John Ducky</h6>
            <p class="user-dropdown-status text-sm text-muted">john@gmail.com</p>
          </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="topbarUserDropdown">
          <li><a wire:navigate class="dropdown-item" href="{{ route('profile.index') }}">My Account</a></li>
...
<nav class="main-navbar">
  <div class="container">
    <ul>
      ...
      <li class="menu-item">
        <a wire:navigate href="{{ route('accounts.index') }}" class='menu-link'>
          <span><i class="bi bi-wallet-fill"></i> Account</span>
        </a>
      </li>
    </ul>
  </div>
